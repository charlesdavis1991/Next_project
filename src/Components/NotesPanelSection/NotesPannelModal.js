      ...
      <Modal.Body className="panel-popups-body">
        <div className="w-100">
          <div className="d-flex justify-content-start" id="notes-form-panel">
            ...
            <Form.Control as="textarea"  id="note_description_panel" style={{marginLeft:"0px !important",marginRight:"0px !important"}} required name="description"
          ...
          <nav className='m-t-5'>  {/* this nav is important -> binds with the notatable class in theme.css (idk why it was done this way) */}
                  ...
                  <div className="tab-pane" id="custom-nav-todo" role="tabpanel" aria-labelledby="custom-nav-todo-tab">
                        <div className="table-responsive table--no-card">
                          <Table className='table table-borderless table-striped table-earning'>
                            <thead>
                              <tr>
                                <th className='INS-width-1px text-uppercase'></th>
                                <th className='text-uppercase'>Date</th>
                                <th className='text-uppercase'>Time</th>
                                <th className="td-autosize text-uppercase">User</th>
