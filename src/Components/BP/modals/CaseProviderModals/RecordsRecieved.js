...
const RecordsRecieved = ({
  ...
  console.log(formData.requestPaid === "NO");
    ...
    <>
      ...
      <div className="row m-0 m-t-5 align-items-end">
        ...
        <div className="col-6 p-r-5">
          <div className="row m-r-0 m-l-0 align-items-center form-group">
            ...
            >
              ...
              <div className="d-flex justify-content-between align-items-center">
                ...
                >
                  {verification?.recordCost === null ? "Verify" : "Unverify"}
                </button>
              </div>
            </div>
              ...
              <div className="d-flex justify-content-between align-items-center ">
                ...
                <div className="d-flex justify-content-around align-items-center ">
                  <p className="m-r-5 d-flex">
                    <input
                      key={formData?.requestPaid} // Force re-render when state changes
                      className="m-r-5"
                      type="radio"
                      name="record_request_paid_yes"
                      value="YES"
...
export default RecordsRecieved;
