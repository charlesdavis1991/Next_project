...
const BillsRequestPaid = ({
  ...
  // const [contactId, setContactId] = useState(paidBill?.id);
  // const [name, setName] = useState(paidBill?.name);
  // const [address1, setAddress1] = useState(paidBill?.address1);
  // const [address2, setAddress2] = useState(paidBill?.address2);
  // const [city, setCity] = useState(paidBill?.city);
  // const [state, setState] = useState(paidBill?.state);
  // const [zip, setZip] = useState(paidBill?.zip);
  // const [phoneNumber, setPhoneNumber] = useState(paidBill?.phone_number);
  // const [fax, setFax] = useState(paidBill?.fax);
  // const [email, setEmail] = useState(paidBill?.email);
  // const [website, setWebsite] = useState(paidBill?.website);
        ...
        <div className={`has-speciality-color-${specialitie?.id} row m-0`}>
          <div className="col-4 m-l-0 p-l-5" style={{ maxWidth: "265px" }}>
            <div style={{ width: "fit-content", maxWidth: "265px" }}>
              ...
              <span style={{ paddingRight: "5px", color: "grey" }}>
                Address:
              </span>
...
export default BillsRequestPaid;
