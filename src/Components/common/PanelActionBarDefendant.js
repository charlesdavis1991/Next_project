...
import PanelChecklistDefendant from "./PanelChecklistDefendant";

const PanelActionBarComponentDefendant = ({
  id,
  page_name,
  title,
  first_name,
...
export default PanelActionBarComponentDefendant;
