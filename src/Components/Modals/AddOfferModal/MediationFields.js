...
const MediationFields = ({ formik, offerCombinations }) => {
    return (
        <div>
                    ...
                    <Form.Group as={Row}>
                        ...
                        <div className="d-flex-1 p-r-15">
                            <Form.Control
                                ...
                                {...formik.getFieldProps("mediation_date")}
                                style={{ appearance: "none" }}
                                onClick={(e) => e.target.showPicker()}
                                isInvalid={formik.touched["mediation_date"] && formik.errors["mediation_date"]}
                                />
                            <Form.Control.Feedback type="invalid">
                            {formik.values.mediation_date}
                        ...
                        <div className="d-flex-1 p-r-15">
                            <input
                                ...
                                name="mediation_litigation_event"
                                id="mediation-litigation-event"
                                onChange={formik.handleChange}
                                checked={formik.values.mediation_litigation_event}
                            />
                        </div>
                    </Form.Group>
                </div>
...
export default MediationFields;
