...
import { addWorkunit } from "../../Redux/workunit-table/workunitSlice";
...
function WorkunitModal({ addWorkunits, handleClose }) {
  ...
  const handleSubmit = async () => {
    try {
      ...
      if (response.status === 201) {
        dispatch(addWorkunit(response.data.data));
        handleClose();
  ...
  return (
    ...
    >
      <Modal.Header className="bg-primary text-center p-2">
        <h4 className="modal-title mx-auto text-white">Add WorkUnit</h4>
      </Modal.Header>
      <Modal.Body>
          ...
          <Tab.Content style={{ height: "600px" }}>
            <Tab.Pane className="overflow-hidden" eventKey="workunit">
              ...
              <div className="row align-items-start form-group">
                <div className="col-2 text-left text-grey">Blocked Stage</div>
                <div className="col-10">
                  <div
                    className="form-control"
                    style={{
