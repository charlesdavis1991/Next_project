...
import "./AddNewProvider.css";
import useGetProviderLocations from "./hooks/useGetProviderLocations";
import { FaStar } from "react-icons/fa";
import useGetProviderBySearchTerms from "./hooks/useGetProviderBySearchTerm";
import AddressRow from "./AddressRow";
import mixColorWithWhite from "../utils/helperFn";
import AddRedirectBackPopUp from "./AddRedirectBackPopUp";
...
function AddNewProvider({ show, handleClose, firmName }) {
  const origin =
        ...
        >
          <div style={{ minHeight: "490px" }}>
            ...
            <Modal.Header
              ...
              className="text-center height-25 p-0 bg-primary-fixed popup-heading-color justify-content-center"
            >
              <Modal.Title
              ...
              >
                Add New Medical Provider to
                {firmName?.for_client?.first_name &&
                firmName?.for_client?.last_name
                  ? ` ${firmName.for_client.first_name} ${firmName.for_client.last_name}'s Case`
                  : " Case"}
              </Modal.Title>
            </Modal.Header>
            <Modal.Body
...
export default React.memo(AddNewProvider);
