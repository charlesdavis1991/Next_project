...
const AddRedirectBackPopUp = ({ show, handleClose, firmName, data }) => {
        ...
        <div>
          <Modal.Header className="text-center height-25 p-0 bg-primary-fixed popup-heading-color justify-content-center">
            <Modal.Title
              ...
              style={{ fontSize: "14px" }}
            >
              You Added a new {data?.specialty?.name} to
          ...
          <Modal.Body className="p-0 p-t-5 d-flex align-items-center justify-content-center">
            <div className="d-flex flex-column align-items-center justify-content-center">
              ...
              >
                You may edit this provider on the Treatment Page.
              </span>
              <span
                style={{
                  fontWeight: "600",
...
export default AddRedirectBackPopUp;
