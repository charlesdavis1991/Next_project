...
import "./ContactPanelTreatment.css";
// import { handleLinkClick } from "../LawFirmDirectoryDashboard/main";
import SendEmailBtn from "../../Modals/SendEmailBtn";
import SendEmailBtnTreatment from "./SendEmailBtnTreatment";
...
const ContactPanelForTreatment = ({
  id,
  panel_name,
  title,
  department,
      ...
      >
        <div className="">
          <div onClick={onSelectObject}>
            ...
            {name?.trim() ? (
              <p
                ...
                className="font-weight-semibold text-capitalize bg-speciality-2 p-r-5 p-l-5 text-truncated"
              >
                {name}
              </p>
            ) : (
              <p
                className="font-weight-semibold text-capitalize bg-speciality-2 p-r-5 p-l-5"
                style={{
            ...
            <div>
              <p
                className="inline-row-h-21 text-capitalize p-r-5 bg-speciality-4 p-l-5"
                style={{
                  backgroundColor: "var(--primary-4)",
                }}
              >
              ...
              <p
                className="inline-row-h-21 text-capitalize bg-speciality-2 p-r-5 p-l-5"
                style={{
                  backgroundColor: "var(--primary-2)",
                }}
              >
            ...
            <div>
              <p
                className="inline-row-h-21 p-r-5 p-l-5 bg-speciality-4"
                style={{
                  backgroundColor: "var(--primary-4)",
                }}
              >
              ...
              <p
                className="inline-row-h-21 p-r-5 p-l-5  bg-speciality-2"
                style={{ backgroundColor: "var(--primary-2)" }}
              >
                {fax_number ? (
                  <span className="font-weight-semibold">
          ...
          {pageName === "treatment" && (
            <div>
              <p
                className="inline-row-h-21 p-r-5 text-center p-l-5 bg-speciality-4"
                style={{ backgroundColor: "var(--primary-4)" }}
              >
                {websiteURL ? (
                  <a
                  ...
                  <a
                    className=""
                    style={{ color: "var(--primary-25)", fontWeight: "600" }}
                  >
        ...
        <div className="mt-auto">
          ...
          {buttonData?.map((button, index) => (
            <a
              ...
              className={`btn btn-hover-contact-panel-row font-weight-semibold text-lg height-25 rounded-0 d-flex align-items-center justify-content-center m-t-5 ${button.className}`}
...
export default React.memo(ContactPanelForTreatment);
