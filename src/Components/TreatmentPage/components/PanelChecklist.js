...
import "./panelchecklist.css";

const PanelChecklistTreatment = ({
  entity_id,
  entity,
  type,
  setTopMargin,
  ...
  async function loadData() {
    try {
      ...
      setTopMargin(response.data?.final_checklist);
  ...
  function dropDownBtn() {
    return (
      <button
        ...
        aria-expanded="false"
        style={{ padding: show ? "0px 10px 0px 3.5px" : "0px 8.5px 0px 3px" }}
      >
        <div
  ...
  function dropDownChecklist() {
    return (
      ...
      >
        <div
          className={type === "sol" ? "panel-skew-box-sol" : "panel-skew-box"}
          style={{ width: "225px" }}
        ></div>
        <div
          ...
          data.map((element, index) => {
            ...
            return (
              <div
                ...
                style={{
                  marginLeft: "auto",
                  backgroundColor: `var(--primary-${index % 2 == 0 ? 5 : 10}) !important`,
                  paddingTop: "2px",
                  paddingBottom: "2px",
                  display: "flex",
                  alignItems: "center",
      ...
      {show ? (
        ...
        >
          <div
            ...
            style={{ width: "225px" }}
          ></div>
          <div className="checklist-section translate-5 p-0 checklist-section-treatment-page-after">
...
export default PanelChecklistTreatment;
