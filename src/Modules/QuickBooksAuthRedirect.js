...
const QuickBooksAuthRedirect = () => {
  useEffect(() => {
    ...
    //   }
      ...
      try {
        const response = await axios.get(`${origin}/api/firmsetting-page/quickBooksRedirect/`, {
          params: { code: code,realmId:realmId },
          headers: {
...
export default QuickBooksAuthRedirect;
